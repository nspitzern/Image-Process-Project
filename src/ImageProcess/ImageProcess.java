...
public class ImageProcess {
    ...
    private void nonMaximumSuppression(Image magnitudes, Image angles) {
    ...
    private boolean checkNeighbourPixels(Image mags, int currentRow, int currentCol, double high) {
